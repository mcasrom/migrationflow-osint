...
- **Frontend**: mapa con clústeres por tipo, niveles, heatmap, tema oscuro, filtro por año
  (2023–2026), **choropleth por país**, capa de rutas migratorias, funnel de bienvenida,
  i18n ES/EN, export CSV/GeoJSON, botón Ko-fi, pestaña Fuentes (metodología, estado, contacto).
...
- Service worker con cache-first para assets: tras un deploy, la primera carga puede servir JS viejo;
  la navegación ya es network-first (SW v7).
