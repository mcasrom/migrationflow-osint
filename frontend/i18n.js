...
const I18N = {
  es: {
    ...
    verify_how: "Cruza el texto con bulos ya desmentidos y con eventos reales de la base de datos.",
  ...
  en: {
    ...
    verify_how: "Cross-checks the text against already-debunked hoaxes and real events in the database.",
