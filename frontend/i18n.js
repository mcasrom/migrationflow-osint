...
const I18N = {
  es: {
    ...
    sources_down: "con fallos consecutivos en el pipeline",
    routes_entries: "entradas",
    cp_note_categories: "Total y desglose por categoría UNHCR (refugiados, asilo, OOC, OIP). Son personas bajo protección internacional; no incluye a la población migrante regular.",
    routes_last_month: "Ultimo mes (Frontex)",
    tab_data: "Datos",
    tab_info: "Fuentes",
    cat: "Categorías",
    ...
    tl_heading: "Evolución en el tiempo",
    tl_play: "▶ Reproducir evolución",
    tl_pause: "❚❚ Pausa",
    tl_resume: "▶ Continuar",
    tl_reset: "✕ Reiniciar",
    tl_note: "Reproduce los eventos del mapa en orden cronológico, del más antiguo a hoy.",
    mode_heading: "Vista temporal",
    mode_historico: "Histórico",
    mode_actual: "Actual (90 d)",
    mode_tendencia: "Tendencia",
    mode_note_actual: "Eventos de los últimos 90 días.",
  ...
  en: {
    ...
    sources_down: "failing consecutively in the pipeline",
    routes_entries: "entries",
    cp_note_categories: "Total and breakdown by UNHCR category (refugees, asylum, OOC, OIP). People under international protection; regular migrants are excluded.",
    routes_last_month: "Last month (Frontex)",
    tab_data: "Data",
    tab_info: "Sources",
    cat: "Categories",
    ...
    year_all: "All years",
    tl_heading: "Evolution over time",
    tl_play: "▶ Play evolution",
    tl_pause: "❚❚ Pause",
    tl_resume: "▶ Resume",
    tl_reset: "✕ Reset",
    tl_note: "Replays the map events in chronological order, from oldest to today.",
    mode_heading: "Time view",
    mode_historico: "Historical",
    mode_actual: "Current (90 d)",
    mode_tendencia: "Trend",
    mode_note_actual: "Events from the last 90 days.",
...
const TYPE_I18N = {
  ...
  asylum_origin: { es: "Solicitantes de asilo (origen)", en: "Asylum-seekers (origin)" },
  ooc_origin: { es: "Otras personas de interés (OOC)", en: "Others of concern (OOC)" },
  oip_origin: { es: "Protección internacional (OIP)", en: "Intl. protection needs (OIP)" },
